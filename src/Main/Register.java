...
public class Register extends javax.swing.JFrame {
    ...
    private void RegisterActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_RegisterActionPerformed
        ...
        if(frontName.isEmpty() || backName.isEmpty() || kelamin.isEmpty() || userEmail.isEmpty() || 
                noHp.isEmpty() || user.isEmpty() || pass.isEmpty()){
            JOptionPane.showMessageDialog(this,"Please fill up he form properly","Error",JOptionPane.ERROR_MESSAGE);
        }else{
